...
- Controlar un ventilador (simulado con un Motor DC gris) de 12V con velocidad variable (dimmer) dependiendo de la temperatura,  y una lámpara 12V que se encienda solo cuando hay personas.
